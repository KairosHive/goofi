...
const SCOPE: Completion[] = [
	...
	{ label: 'lfo', type: 'function', detail: 'sine wave — lfo(src=t, vmin=slider min, vmax=slider max)', boost: 1 },
	{ label: 'noi', type: 'function', detail: 'smooth noise — noi(src=t, vmin=slider min, vmax=slider max)', boost: 1 },
